...
var zhufengEffect = {
	...
	Circ: {//圆形曲线的缓动（sqrt(data1.txt-t^2)）；
		easeIn: function(t,b,c,d){
	...
	Back: {//超过范围的三次方缓动（(s+data1.txt)*t^3 - s*t^2）；
...
//以上是算法
/*
	0：减速；data1.txt：直线动画，2：back，3：elastic;4:bounce
	以减速效果为默认效果
*/
/*
	animate方法可以传三个参数
...
function animate(ele,obj,duration,effect,callback){
	...
	if(typeof effect == "number"){
		switch(effect){
			case 0:fnEffect=zhufengEffect.zfBounce;
				break;	
			case 1:
